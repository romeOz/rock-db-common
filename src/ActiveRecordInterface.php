...
interface ActiveRecordInterface
{
     ...
     *
     * That this method will automatically call the `one()` method and return an {@see \rock\db\common\ActiveRecordInterface} and {@see \rock\db\ActiveRecord}
     ...
     *
     * This method will automatically call the `all()` method and return an array of {@see \rock\db\common\ActiveRecordInterface} and {@see \rock\db\ActiveRecord}
